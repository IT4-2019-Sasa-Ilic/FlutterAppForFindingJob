...
class _SignUpState extends State<SignUp> with TickerProviderStateMixin{
  ...
  late TextEditingController _fullNameController = new TextEditingController(text: '');
  ...
  late TextEditingController _locationController = new TextEditingController(text: '');
  late TextEditingController _phoneNumberController = new TextEditingController(text: '');
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(16),
                                child: imageFile==null ? Icon(Icons.camera_enhance,color: Colors.blue,size: 30) : Image.file(imageFile!,fit: BoxFit.fill),
                              ),
                            ),
                          ),
                        ),
